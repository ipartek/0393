...
<%@include file="../includes/navbar.jsp"%>
   	...
   	<ul class="list-group">
	  <li class="list-group-item"><a href="basico.jsp">Ejemplo Servlet Basico sin JSP</a></li>
	  <li class="list-group-item"><a href="basico2.jsp">Ejemplo Servlet Basico con JSP</a></li>
	  <li class="list-group-item"><a href="basico3.jsp">Ejemplo Servlet Response Content Type</a></li>
	  <li class="list-group-item"><a href="basico4.jsp">GET y POST</a></li>
	  ...
	  <li class="list-group-item"><a href="calculadora.jsp">Calculadora</a></li>
	  <li class="list-group-item"><a href="el.jsp">EL - Expression Language</a></li>
