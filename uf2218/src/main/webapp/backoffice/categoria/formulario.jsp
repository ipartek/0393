...
<%@include file="../../includes/navbar.jsp"%>
	...
	<a href="backoffice/categoria" class="btn btn-outline-primary">Ver categorias</a>
		...
		<div class="col">
			...
			<form action="backoffice/categoria" method="post" class="mb-2">
				...
				<div class="form-group">	
					...
					<input class="form-control" type="text" name="id" value="${categoria.id}" readonly class="form-control">
				</div>
