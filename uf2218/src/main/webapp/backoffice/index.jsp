...
<div class="row">
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
      <div class="card text-white bg-success o-hidden h-100">
        ...
        <a class="card-footer text-white clearfix small z-1" href="backoffice/usuarios?op=<%=UsuariosController.OP_LIST%>&activos=true">
      ...
      <div class="card text-white bg-warning o-hidden h-100">
        ...
        <a class="card-footer text-white clearfix small z-1" href="backoffice/usuarios?op=<%=UsuariosController.OP_LIST%>&activos=false">
          <span class="float-left">Ver Listado</span>
          <span class="float-right">
            <i class="fas fa-angle-right"></i>
          </span>
