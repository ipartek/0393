...
INSERT INTO `usuario` VALUES (1,'admin','admin'),(2,'pepe','pepe'),(3,'lucas','lucas'),(4,'jon','jon'),(8,'borja','borja00'),(9,'eder','ederi'),(10,'ander','ander');
...
CREATE TABLE `video` (
  ...
  CONSTRAINT `FK_VIDEO_TIENE_USUARIO` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`)
...
-- Dump completed on 2019-09-04 13:02:34
