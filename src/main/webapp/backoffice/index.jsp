          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">${numeroUsuariosV} usuarios</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="backoffice/usuario?isVisible=true">
                <span class="float-left">Ver listado</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
         ...
         <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">${numeroUsuariosE} usuarios eliminados</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="backoffice/usuario?isVisible=false">
                <span class="float-left">Ver listado</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
